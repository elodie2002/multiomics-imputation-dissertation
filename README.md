...
│
├── Main_Dataset/
│   └── Imputation_datasets/   # Download from the original MLOmics repository if not included
│
├── final_analysis_csv/
│
...
The repository includes final result CSV files used for dissertation analysis, including:

* final DAE benchmark results;
* final VAE benchmark results;
* final GAIN benchmark results;
* hyperparameter tuning results;
* aggregated analysis CSV files;
* deeper insight and failure-localisation CSV files.

These files are included to support transparency and reproducibility of the reported findings.
